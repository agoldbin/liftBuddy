...
--
-- Host: 127.0.0.1    Database: liftbuddy
-- ------------------------------------------------------
...
LOCK TABLES `role` WRITE;
/*!40000 ALTER TABLE `role` DISABLE KEYS */;
INSERT INTO `role` VALUES (1,'admin','jcoyne',1),(2,'buddy','fhensen',2),(3,'buddy','bcurry',3),(4,'buddy','kmack',4),(5,'buddy','dklein',5),(6,'buddy','dtillman',6),(7,'admin','agoldbin',7),(18,'buddy','fflintstone',252);
/*!40000 ALTER TABLE `role` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
