# INSERT INTO weight (weight, user_id) VALUES (1,115),(1,120),(2,225),(2,180),(3,140),(3,145),(3,100);
DELETE from weight;
delete from user;
delete from gym;
...
INSERT INTO weight (weight, user_id) VALUES (115,1),(120,1),(225,2),(180,2),(140,3),(145,3),(100,3);
