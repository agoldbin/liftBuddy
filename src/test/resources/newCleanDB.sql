...
CREATE TABLE IF NOT EXISTS weight (weight_id int auto_increment primary key, weight int null, user_id int null, constraint weight_user_id_fk foreign key (user_id) references user (id) engine=InnoDB;
CREATE INDEX weight_user_id_fk on weight (user_id);
