<%-- This jsp contains the code for the footer --%>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="row">
            <div class="col l6 s12">
                <h5 class="white-text">Lift Buddy</h5>
            ...
            <div class="col l4 offset-l2 s12">
                ...
                <ul>
                    ...
                    <li><a class="grey-text text-lighten-3" href="/LiftBuddy/adminSearch.jsp">Admin</a></li>
                </ul>
            </div>
        </div>
    </div>
